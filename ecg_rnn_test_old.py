...
# Test file
test_filename_queue = tf.train.string_input_producer(["train.tfrecords"])

t_label, t_features = read_and_decode(filename_queue)
...
with tf.Session() as session:
    ...
    try:
        while not coord.should_stop():
            ...
            acc = session.run(accuracy, feed_dict={x: x_r, y: y_r})
